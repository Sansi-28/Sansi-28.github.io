...
const Footer = () => {
  return (
    <footer className="bg-black/50 mt-20 py-8">
      <div className="container mx-auto px-4 md:px-8 text-center text-gray-400">
        <div className="flex justify-center space-x-6 mb-6">
          <a href={SOCIAL_LINKS.github} target="_blank" rel="noopener noreferrer" className="hover:text-pixel-pink transition-colors">
            <GithubIcon />
          </a>
          <a href={SOCIAL_LINKS.linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-pixel-pink transition-colors">
            <LinkedinIcon />
          </a>
          <a href={SOCIAL_LINKS.twitter} target="_blank" rel="noopener noreferrer" className="hover:text-pixel-pink transition-colors">
            <TwitterIcon />
          </a>
        </div>
        <p className="text-xs tracking-widest">© {new Date().getFullYear()} PixelDev. All Rights Reserved.</p>
        <p className="text-xs mt-2">INSERT COIN TO CONTINUE</p>
      </div>
    </footer>
  );
};
